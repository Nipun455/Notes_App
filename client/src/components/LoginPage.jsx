...
const USER_URL=import.meta.env.REACT_APP_BASE_URL;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isLogin) {
                ...
                const res = await axios.post(`${USER_URL}/api/v1/user/login`, userData);
                if (res.data) {
                ...
                const res = await axios.post(`${USER_URL}/api/v1/user/signup`, userData); // Use the appropriate signup URL
                if (res.data) {
